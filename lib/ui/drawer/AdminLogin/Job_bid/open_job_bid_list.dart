...
class OpenJobBidListScreen extends GetView<OpenJobBidListController> {
  String? jobId;
  OpenJobBidListScreen({this.jobId,Key? key}) : super(key: key);

  OpenJobBidListController controller = Get.put(OpenJobBidListController());

  @override
  Widget build(BuildContext context) {
    controller.jobId.value  =  jobId!;
    return Obx(() => Scaffold(
