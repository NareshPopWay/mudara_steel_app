...
class ComplitedJobListScreen extends GetView<ComplitedJobController> {
  ComplitedJobListScreen({Key? key}) : super(key: key);

  ComplitedJobController controller = Get.put(ComplitedJobController());
            ...
            children: [
                      ...
                      child: Center(
                        child: CupertinoSearchTextField(
                          ...
                          onSuffixTap: () {
                            ...
                            controller.completedJobList.clear();
                            controller.getComplitedJob();
                            controller.searchTextEditController.clear();
              ...
              Expanded(
                  child: ListView(
                    ...
                    children: [
                      if (controller.completedJobList.isEmpty && !controller.isJobListLoading.value)
                        Padding(
                        ...
                        ListView.builder(
                            ...
                            itemCount: controller.completedJobList.length,
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          headerRow1(
                                            title1: controller.completedJobList[index].createdOn != null
                                                ? DateFormat("dd/MM/yyyy").format(DateTime.parse(controller.completedJobList[index].createdOn.toString()))
                                                : "-",
                                            icon1: Icon(Icons.calendar_month, size: AppSpacings.s25),
                                            title2: controller.completedJobList[index].jobName ?? "-",
                                            icon2: null,
                                          ),
                                          // Container(
                                                    ...
                                                    children: [
                                                                ...
                                                                return SlideTransition(
                                                                  ...
                                                                  child: Opacity(
                                                                    ...
                                                                    child: AlertDialog(
                                                                      ...
                                                                      content: deleteJob(context,controller.completedJobList.isNotEmpty ? controller.completedJobList[index].jobId:0 , controller.completedJobList.isNotEmpty ? controller.completedJobList[index].jobName:''),
                                                                    ),
                                                                  ),
                                                                );
                                                              });
                                                      ...
                                                      Bounce(
                                                        ...
                                                        onPressed: (){
                                                          Get.toNamed(
                                                            Routes.createJob,
                                                            arguments: controller.completedJobList[index].jobId.toString(),
                                                          );
                                                        },
                                                        child: Container(
                                                          padding: EdgeInsets.symmetric(horizontal: AppSpacings.s20, vertical: AppSpacings.s8),
