...
class VendorListScreen extends GetView<VendorListController> {
   VendorListScreen({Key? key}) : super(key: key);

  VendorListController controller = Get.put(VendorListController());
  ...
  Widget build(BuildContext context) {
                ...
                children: [
                  ...
                  Expanded(
                      child:  ListView(
                        ...
                        children: [
                          if (controller.vendorList.isEmpty && !controller.isVendorListLoading.value)
                            Padding(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  controller.vendorList[index].createdOn != null
                                                      ? DateFormat("dd/MM/yyyy").format(DateTime.parse(controller.vendorList[index].createdOn.toString()))
                                                      : "-",
                                            ...
                                            Row(
                                              children: [
                                                Text(
                                                  controller.vendorList[index].code ?? "-",
                                                  overflow: TextOverflow.ellipsis,
                                                  style: Get.textTheme.displayMedium!.copyWith(
                                                    color: Colors.black,
                                                    fontWeight: FontWeight.w700,
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                          ...
                                                          return SlideTransition(
                                                            ...
                                                            child: Opacity(
                                                              ...
                                                              child: AlertDialog(
                                                                ...
                                                                content: deleteVendor(context,controller.vendorList.isNotEmpty ? controller.vendorList[index].vendorId:0 , controller.vendorList.isNotEmpty ? controller.vendorList[index].vendorName:''),
                                                              ),
                                                            ),
                                                          );
                                                        });
                                                ...
                                                Bounce(
                                                  duration: const Duration(milliseconds: 100),
                                                  onPressed: (){
                                                    Get.toNamed(Routes.registerVendor,arguments:controller.vendorList[index].vendorId.toString());
                                                  },
                                                  child: Container(
                                                    padding: EdgeInsets.symmetric(horizontal: AppSpacings.s20, vertical: AppSpacings.s8),
                                                    decoration: BoxDecoration(
   ...
   deleteVendor(context,vendorId,jobName){
     return Obx(() => Padding(
       padding:
         ...
         children: [
           ...
           Row(
             ...
             children: [
               ...
               controller.isDeleteVendor.value
                   ? SizedBox(
                   width: AppSpacings.s90,
                 ...
                 onPressed: () async {
                   FocusScope.of(context).unfocus();
                   controller.deleteVendor(context,vendorId: vendorId);
                 },
                 child: Container(
                   width: AppSpacings.s90,
                   padding:  EdgeInsets.all(AppSpacings.s8),
