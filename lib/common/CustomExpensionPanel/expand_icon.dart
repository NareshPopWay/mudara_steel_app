    ...
    return Semantics(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          // ),
          borderRadius: BorderRadius.only(topRight: Radius.circular(AppSpacings.s14)),
        ),
        child: IconButton(
          ...
          icon: RotationTransition(
            ...
            child: Transform.rotate(
                ...
                child: Icon(Icons.play_arrow_rounded,
                  color:  widget.isExpanded ? ThemeService.white : ThemeService.primaryColor.withOpacity(0.7),
                )),
          ),
        ),
      ),
