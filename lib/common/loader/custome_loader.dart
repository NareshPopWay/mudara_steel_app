...
import 'package:mudara_steel_app/common/loader/spinkit_loader.dart';
...
class OverlayLoaderWithAppIcon extends StatelessWidget {
  ...
  OverlayLoaderWithAppIcon({required this.isLoading, required this.child, this.appIcon, this.appIconSize=50,
