...
/// Spacing with value of 13 * `scaleFactor`
  static double get s13 => 13 * _scaleFactor;
  ...
  /// Spacing with value of 19 * `scaleFactor`
  static double get s19 => 19 * _scaleFactor;
 ...
 /// Spacing with value of 26 * `scaleFactor`
  static double get s26 => 26 * _scaleFactor;

 /// Spacing with value of 27 * `scaleFactor`
  static double get s27 => 27 * _scaleFactor;

 /// Spacing with value of 28 * `scaleFactor`
  static double get s28 => 28 * _scaleFactor;

 /// Spacing with value of 29 * `scaleFactor`
  static double get s29 => 29 * _scaleFactor;
  ...
  /// Spacing with value of 48 * `scaleFactor`
  static double get s85 => 85 * _scaleFactor;
  ...
  static double get s75 => 75 * _scaleFactor;

  /// Spacing with value of 100 * `scaleFactor`
  static double get s100 => 100 * _scaleFactor;

  /// Spacing with value of 100 * `scaleFactor`
  static double get s110 => 110 * _scaleFactor;

  static double get s90 => 90 * _scaleFactor;
  ...
  /// Spacing with value of 150 * `scaleFactor`
  static double get s160 => 160 * _scaleFactor;

  /// Spacing with value of 150 * `scaleFactor`
  static double get s170 => 170 * _scaleFactor;
  ...
  /// Spacing with value of 200 * `scaleFactor`
  static double get s220 => 220 * _scaleFactor;

  /// Spacing with value of 200 * `scaleFactor`
  static double get s240 => 240 * _scaleFactor;
  ...
  /// Spacing with value of 380 * `scaleFactor`
  static double get s380 => 380 * _scaleFactor;

  /// Spacing with value of 280 * `scaleFactor`
  static double get s280 => 280 * _scaleFactor;

  /// Spacing with value of 290 * `scaleFactor`
  static double get s290 => 290 * _scaleFactor;
  ...
  static double get s500 => 500 * _scaleFactor;

  static double get s600 => 600 * _scaleFactor;

  static double get s700 => 700 * _scaleFactor;

  /// Spacing that returns the passed value * `scaleFactor`
  static double customValue(num value) => value * _scaleFactor;
}
